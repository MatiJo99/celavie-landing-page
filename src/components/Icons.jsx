...
export function TikTokIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
      <path d="M16.6 5.82A4.28 4.28 0 0 1 15.54 3h-3.09v12.4a2.59 2.59 0 0 1-2.59 2.5 2.59 2.59 0 1 1 .76-5.07V9.66a5.68 5.68 0 0 0-.76-.05A5.68 5.68 0 1 0 15.54 15.3V8.9a7.34 7.34 0 0 0 4.3 1.38V7.2a4.29 4.29 0 0 1-3.24-1.38Z" />
    </svg>
  );
}
...
export function PhoneIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true" {...props}>
      <path
        d="M6.6 3.5h2.2l1.4 3.5-1.8 1.3a11.5 11.5 0 0 0 5.3 5.3l1.3-1.8 3.5 1.4v2.2a2 2 0 0 1-2.2 2A15.7 15.7 0 0 1 4.6 5.7a2 2 0 0 1 2-2.2Z"
...
export function PinIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" aria-hidden="true" {...props}>
      <path d="M12 21s7-5.4 7-10.5A7 7 0 1 0 5 10.5C5 15.6 12 21 12 21Z" strokeLinejoin="round" />
...
export function StarIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
      <path d="m12 17.6-5.3 3 1.4-6-4.6-4 6.1-.5L12 4.4l2.4 5.7 6.1.5-4.6 4 1.4 6z" />
    </svg>
  );
}
